...
var settingForKey = require('sketch/settings').settingForKey;
var setSettingForKey = require('sketch/settings').setSettingForKey;
var setLayerSettingForKey = require('sketch/settings').setLayerSettingForKey;
var layerSettingForKey = require('sketch/settings').layerSettingForKey;
var setDocumentSettingForKey = require('sketch/settings').setDocumentSettingForKey;
var documentSettingForKey = require('sketch/settings').documentSettingForKey;
